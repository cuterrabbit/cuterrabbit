...
<img src="https://readme-typing-svg.herokuapp.com/?font=Fira+Code&size=20&pause=1200&color=38A3A5&center=true&vCenter=true&width=650&lines=MCP-based+AIOps+%C2%B7+LLM+Agent+Backend;Docker+%26+Kubernetes+Internals;RAG+Pipeline+Automation" />
...
➔ 결국 **데이터가 흐르는 아키텍처를 설계**하는 게 더 재밌어서 IT로 정착했습니다.  
현재는 백엔드, 클라우드, 그리고 인프라를 열심히 공부하고 있습니다.
<br>
